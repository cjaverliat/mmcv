...
from mmcv.transforms import LoadAnnotations, LoadImage, LoadImageFromFile
...
class TestLoadImageFromFile:
    ...
    def test_load_img(self):
        ...
        with pytest.raises(
            ...
            LoadImageFromFile(
                file_client_args={"backend": "disk"}, backend_args={"backend": "disk"}
            )
...
class TestLoadAnnotations:
    ...
    def setup_class(cls):
        ...
        cls.results = {
            ...
            "instances": [
                ...
                {"bbox": [10, 10, 110, 120], "bbox_label": 2, "keypoints": [4, 5, 6]},
            ],
        }
    ...
    def test_load_kps(self):
        ...
        assert (results["gt_keypoints"] == np.array([[[1, 2, 3]], [[4, 5, 6]]])).all()
