...
class TestMaskedConv2d:
    ...
    def test_masked_conv2d_all_close(self, device):
        ...
        np_input = np.load("tests/data/for_masked_conv2d/masked_conv2d_for_input.npy")
        np_mask = np.load("tests/data/for_masked_conv2d/masked_conv2d_for_mask.npy")
        np_weight = np.load("tests/data/for_masked_conv2d/masked_conv2d_for_weight.npy")
        np_bias = np.load("tests/data/for_masked_conv2d/masked_conv2d_for_bias.npy")
        np_output = np.load("tests/data/for_masked_conv2d/masked_conv2d_for_output.npy")
