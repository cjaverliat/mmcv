...
class TestBoxIoURotated:
    ...
    def test_box_iou_rotated_cpu(self):
        ...
        np_expect_ious = np.asarray(
            [
                [0.3708, 0.4351, 0.0000],
                [0.1104, 0.4487, 0.0424],
    ...
    def test_box_iou_rotated_iof_cpu(self):
        ...
        np_expect_ious = np.asarray(
            [
                [0.4959, 0.5306, 0.0000],
                [0.1823, 0.5420, 0.1832],
                [0.0000, 0.0000, 0.4404],
            ],
            dtype=np.float32,
        )
        np_expect_ious_aligned = np.asarray([0.4959, 0.5420, 0.4404], dtype=np.float32)
