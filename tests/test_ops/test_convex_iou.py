...
np_polygons = np.asarray(
    [[1.0, 1.0, 1.0, 2.0, 2.0, 2.0, 2.0, 1.0], [1.0, 1.0, 1.0, 3.0, 3.0, 3.0, 3.0, 1.0]]
)
...
def test_convex_iou():
    ...
    assert torch.allclose(convex_iou(pointsets, polygons), expected_iou, atol=1e-3)
