...
ext_module = ext_loader.load_ext(
    "_ext", ["prroi_pool_forward", "prroi_pool_backward", "prroi_pool_coor_backward"]
)
...
class PrRoIPoolFunction(Function):
    ...
    def forward(
        ...
        output_shape = (rois.size(0), features.size(1), pooled_height, pooled_width)
...
class PrRoIPool(nn.Module):
    ...
    def __init__(self, output_size: Union[int, tuple], spatial_scale: float = 1.0):
        super().__init__()
