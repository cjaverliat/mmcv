...
def nms_rotated(
    ...
    """Performs non-maximum suppression (NMS) on the rotated boxes according to their
...
def nms_quadri(
    ...
    """Performs non-maximum suppression (NMS) on the quadrilateral boxes according to
